<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDash.aspx.cs" Inherits="SpaNSalon.Dash2" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            ...
                            <div class="btn-toolbar mb-2 mb-md-0">
                                <div class="btn-group me-2">
                                    <a class="btn btn-sm btn-outline-secondary" href="AdminDash4.aspx">Show In Progress</a>
                                </div>                                
                            </div>
                        </div>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MajorProjectConnectionString %>" SelectCommand="SELECT * FROM [all_info] where status='A' OR status='D'"></asp:SqlDataSource>
